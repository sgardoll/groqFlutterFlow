...
class GroqKeyWidget extends StatefulWidget {
  ...
  @override
  State<GroqKeyWidget> createState() => _GroqKeyWidgetState();
}

class _GroqKeyWidgetState extends State<GroqKeyWidget> {
  late GroqKeyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GroqKeyModel());
